...
def start_the_game():
    ...
    print(r""" 
        ...
        |_|  |_|\__,_|_| |_|\__, |_| |_| |_|\__,_|_| |_|
                             __/ | 
                            |___/
        how the hangman look in the start: 
        x-------x
        |
        |
        |
    ...
    index = int(input("הזן את המיקום של המילה שברצונך לבחור: "))
    """
...
def print_how_the_hangman_look(tries):
    ...
    color_order = ["green", "blue", "yellow", "red", "pink", "cyan"]
    selected_color = colors[color_order[tries - 1]]  # צבע מתאים למספר הניסיונות
    # החזרת הטקסט בצבע המבוקש
    return f"{selected_color}{hangman_states[tries - 1]}\033[0m"
