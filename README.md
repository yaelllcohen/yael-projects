...
שרת קבצים שיצרתי
תכונות עיקריות:
ממשק משתמש ב-Tkinter ללקוח (העלאת/הורדת/יצירת קבצים, רשימת קבצים מקומית).
שמירת היסטוריית פעולות ובקרת הרשאות באמצעות SQLite.
תמיכה ב־upload / download, יצירת שמות קבצים, והצגת סטטוס ההעברה.
